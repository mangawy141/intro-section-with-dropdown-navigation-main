...
let mobile_menu_feat_drop = document.querySelector(".mobile-menu .features-drop-down");
...
let mobile_company_arrow = document.querySelector(
  ".mobile-menu .company img"
);
let mobile_company_drop_down = document.querySelector(".mobile-menu .company-drop-down");
